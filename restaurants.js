...
db.restaurants.find({"$or": [{"cuisine": {"$nin": ["American", "Chinese"], "$eq": "Fish"}}, {"name": /^Wil/ }]}, {"_id": 0, "restaurant_id": 1, "name": 1, "borough": 1, "cuisine": 1});

// 22. Show restaurant_id, name, borough and grades of all restaurants with a grade of 'A' and a score of 11 in ISODate '2014-08-11T00:00:00Z'
db.restaurants.find({"grades": {"$elemMatch": {"grade": "A", "score": 11, "date": {"$eq": ISODate("2014-08-11T00:00:00Z")}}}}, {"_id": 0, "restaurant_id": 1, "name": 1, "borough": 1, "grades": 1});

// 23. Show restaurant_id, name, borough and grades of all restaurants whose second a grade's has a grade of 'A' and a score of 11 in ISODate '2014-08-11T00:00:00Z'
